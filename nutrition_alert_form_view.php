                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-2 mb-3"><small class="text-muted d-block">ชื่อ - สกุล</small><span class="font-weight-bold" style="font-size: 0.95rem;"><?= htmlspecialchars($data['patient_firstname'] . ' ' . $data['patient_lastname']) ?></span></div>
