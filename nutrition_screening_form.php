                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 col-lg-2 mb-3"><small class="text-muted d-block">ชื่อ - สกุล</small><span class="font-weight-bold" style="font-size: 0.95rem;"><?php echo htmlspecialchars($patient['patient_firstname']) . ' ' . htmlspecialchars($patient['patient_lastname']); ?></span></div>
                ...
                <div class="form-header-box">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        ...
                        <div class="text-right">
                            <span id="docIdBadge" class="badge badge-info p-2" style="font-size: 0.9rem;">เลขที่เอกสาร: <?php echo htmlspecialchars($doc_no_show); ?></span>
                        </div>
                    </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <div class="d-flex align-items-center bg-light p-2 rounded border">
                                    <span class="mr-3 font-weight-bold text-secondary small">ประเมินน้ำหนักโดย: <span class="text-danger">*</span></span>
